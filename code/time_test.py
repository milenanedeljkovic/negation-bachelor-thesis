...
t1 = timeit.timeit("nlp1(I like making clothes, but right now I am out of sewing thread.)", number=20)
t2 = timeit.timeit("nlp2(I like making clothes, but right now I am out of sewing thread.)", number=20)
